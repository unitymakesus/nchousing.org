...
$emailURL = 'mailto:?subject='.$crunchifyTitle.'&amp;body='.$crunchifyTweet.$crunchifyURL;
?>

<div class="social-share-modal hidden-print print-no">
    <a class="modal-toggle btn btn-primary pull-right" data-toggle="modal" data-target="#social-share-modal_<?php echo $post->post_name; ?>" href="#"><span class="icon-share-dots"></span></a>
    ...
    <div class="modal fade" id="social-share-modal_<?php echo $post->post_name; ?>" tabindex="-1" role="dialog" aria-labelledby="social-share-modal">
      <div class="modal-dialog" role="document">
        ...
        $filename = '/data-viz/' . $post_name . '-annotated.png';

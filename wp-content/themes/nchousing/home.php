...
<section class="nc-map">
  ...
  <div class="wrap-content">
    ...
    <a class="btn-skew btn btn-gold btn-lg" href="https://ncsu.maps.arcgis.com/apps/webappviewer/index.html?id=cd1f4b3a459544b8893c376ab8dae3c0"><span class="shape"></span>Mapping Housing Affordability in North Carolina <i class="glyphicon glyphicon-menu-right" aria-hidden="true"></i></a>
  </div>
</section>
